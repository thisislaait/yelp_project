...
const Banner = () => {
  return (
    <div className="banner my-2.5 ml-12 mr-16 py-5 px-4 md:ml-20 md:mr-28" style={{ backgroundColor: 'rgb(247, 242, 231)' }}>
        <h1 className="text-2xl md:text-3xl font-bold py-1 pl-5 pr-20">Welcome To YelpCamp!</h1>
        <p className="text-sm md:text-base pr-16 pl-5 md:pr-80">View our hand-picked campgrounds from all over the world, or add your own.</p>
